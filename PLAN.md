...
- [~] Mention-triggered replies — **core paths live & tested**: DM peer auto-reply + `@mentionName` match against the sender's own connections (hooked into message-send, fire-and-forget). Remaining: web/mobile rendering of streaming deltas
